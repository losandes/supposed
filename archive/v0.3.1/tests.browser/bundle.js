...
(function (root) {
  ...
  function BrowserConsolePrinter(styles, SYMBOLS) {
    ...
    var print = function print(level, line) {
    ...
    print.success = function (behavior) {
      print('info', SYMBOLS.passed + behavior);
    };

    print.skipped = function (behavior) {
      print('warn', SYMBOLS.skipped + behavior);
    };

    print.failed = function (behavior, e) {
      print('error', SYMBOLS.failed + behavior);
    ...
    print.info = function (behavior, e) {
      print('info', SYMBOLS.info + behavior);
    ...
    print.totals = function (totals) {
      print('info', '  total: ' + totals.total);
      print('info', '  passed: ' + totals.passed);
      print('info', '  failed: ' + totals.failed + totals.broken);
      print('info', '  skipped: ' + totals.skipped);
      print('info', '  duration: ' + (totals.endTime - totals.startTime) / 1000 + 's');
    };
  ...
  module.exports = {
    name: 'BrowserReporterFactory',
    factory: BrowserReporterFactory
  };

  function BrowserReporterFactory(TestEvent, DefaultReporter, Reporter, DefaultBrowserPrinter, QuietPrinter, TapPrinter) {
    var reporters = {
      // BLOCK: 'BLOCK',
      // BRIEF: 'BRIEF',
      DEFAULT: 'DEFAULT',
      ...
      get: function get(name) {
        switch (name) {
          case reporters.QUIET:
            return new DefaultReporter(new QuietPrinter(styles), TestEvent);

          case reporters.TAP:
            return new DefaultReporter(new TapPrinter(styles), TestEvent);

          default:
            return new DefaultReporter(new DefaultBrowserPrinter(styles, SYMBOLS), TestEvent);
        }
      },
  ...
  function TapPrinter(streamPrinter) {
    ...
    print.startTest = function (plan) {
      specCount += 1;
      testCount = 0;
      print("".concat(specCount, "..").concat(plan && plan.count || 1));
    };
  ...
  function ReporterFactory(Reporter) {
  ...
  (function () {
    var AsyncTest = new module.factories.AsyncTest(module.factories.TestEvent);
    var DefaultRunner = new module.factories.DefaultRunner(module.factories.TestEvent, module.factories.promiseUtils);
    var DefaultReporter = module.factories.DefaultReporter(module.factories.Reporter);
    var reporterFactory = new module.factories.BrowserReporterFactory(module.factories.TestEvent, DefaultReporter, module.factories.Reporter, module.factories.DefaultBrowserPrinter, module.factories.QuietPrinter, module.factories.TapPrinter);
    var reporters = {
...
},{"../dist/supposed.js":1,"./sample-specs.js":40,"chai":3}]},{},[41]);
