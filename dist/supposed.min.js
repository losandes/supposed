...
function Supposed(options){var _module$factories$all=module.factories.allSettledFactory({}),allSettled=_module$factories$all.allSettled;var _module$factories$mak=module.factories.makePlansFactory({allSettled:allSettled}),makePlans=_module$factories$mak.makePlans;var envvars={assertionLibrary:{},reporters:["LIST"],useColors:true,timeUnits:"us",reportOrder:REPORT_ORDERS.NON_DETERMINISTIC};var _module$factories$rep=module.factories.reporterFactoryFactory({}),ReporterFactory=_module$factories$rep.ReporterFactory;var reporterFactory=new ReporterFactory;var _module$factories$mak2=module.factories.makeSuiteConfigFactory({envvars:envvars,reporterFactory:reporterFactory}),makeSuiteConfig=_module$factories$mak2.makeSuiteConfig;var config=makeSuiteConfig(options);var clock=function clock(){return time.clock(config.timeUnits)};var duration=function duration(start,end){return time.duration(start,end,config.timeUnits)};var _module$factories$Tes=module.factories.TestEventFactory({clock:clock,envvars:config}),TestEvent=_module$factories$Tes.TestEvent;var _module$factories$pub=module.factories.pubsubFactory({allSettled:allSettled,isPromise:isPromise,TestEvent:TestEvent}),Pubsub=_module$factories$pub.Pubsub;var pubsub=new Pubsub;var consoleStyles=module.factories.consoleStylesFactory({envvars:config}).consoleStyles;var _module$factories$Tal=module.factories.TallyFactory({pubsub:pubsub,TestEvent:TestEvent,clock:clock,duration:duration}),TallyFactory=_module$factories$Tal.TallyFactory;var _TallyFactory=TallyFactory({}),Tally=_TallyFactory.Tally;reporterFactory.add(Tally);var ArrayReporter=module.factories.ArrayReporterFactory({}).ArrayReporter;reporterFactory.add(ArrayReporter);// @deprecated - legacy support
